...
//        VecCol[vecNum].ID[0]=getColor(104,76);
        ...
        VecCol[vecNum].ID[0]=color_test(VecCol[vecNum].X,VecCol[vecNum].Y);
        //保存信息完成
...
//        continue;
    ...
    if(abs(calRadius-radius)<4){
        ...
        VecCol[vecNum].ID[0]=color_test(center.x,center.y);
...
//        cout<<"ellipse!!!"<<endl;
        ...
        VecCol[vecNum].ID[0]=color_test(ellipse.center.x,ellipse.center.y);
